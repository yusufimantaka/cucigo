  ...
  return (
    <div className="mobile-frame">
      <div className="flex flex-1 flex-col overflow-hidden bg-bg">
        ...
        <div className="h-[280px] relative overflow-hidden shrink-0 bg-gradient-to-br from-primary-50 to-primary-100">
          ...
          <div className="absolute top-[38%] left-[32%] w-[36px] h-[36px] bg-primary-500 rounded-[50%_50%_50%_0] -rotate-45 flex items-center justify-center shadow-[0_2px_8px_oklch(42%_0.12_190_/_0.4)]" style={{ zIndex: 2 }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="white" className="rotate-45">
              <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" />
            </svg>
          </div>
          <div className="absolute top-[55%] left-[58%] w-[32px] h-[32px] bg-secondary rounded-[50%_50%_50%_0] -rotate-45 flex items-center justify-center shadow-[0_2px_8px_oklch(68%_0.16_35_/_0.5)] animate-pulse" style={{ zIndex: 2 }}>
          ...
          <div className="absolute bottom-3 left-4 right-4 bg-surface rounded-2xl p-3 flex items-center gap-3 shadow-lg" style={{ zIndex: 3 }}>
            ...
            <button className="flex h-[40px] w-[40px] items-center justify-center rounded-full bg-primary-50 border-none cursor-pointer text-primary-600">
